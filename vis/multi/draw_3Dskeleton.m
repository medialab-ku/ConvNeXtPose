function f = draw_3Dskeleton(img, pred_3d_kpt, num_joint, skeleton, colorList_joint, colorList_skeleton, pred_3d_kpt_pivot)
    ...
    x = pred_3d_kpt_pivot(:,:,1);
    y = pred_3d_kpt_pivot(:,:,2);
    z = pred_3d_kpt_pivot(:,:,3);
    pred_3d_kpt_pivot(:,:,1) = -z;
    pred_3d_kpt_pivot(:,:,2) = x;
    pred_3d_kpt_pivot(:,:,3) = -y;
